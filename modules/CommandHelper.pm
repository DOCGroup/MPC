...
#
#                 The get() method takes the basename of the provided
#                 command, converts it to uppercase and adds 'Helper' to
#                 the end.  If a module is found matching that name, it
#                 will be used to assist the ProjectCreator in
#                 determining which output files will be generated by the
#                 command give the file name and command options.
#
# Author        : Chad Elliott
...
sub get {
  ...
  my $type = uc(basename($cmd)) . 'Helper';
